function [idx,module_means,module_coherence] = agglomerative_clustering_meanCC_avglink(data, module_coherence_thres, merging_thres)
% each row of data matrix is one node (gene) to be clustered
% the algorithm goes bottom-up. 
% module_coherence_thres: target coherence threshold of a module, 0.7~0.9, 
%                         in the cluster result, the average gene-to-center correlation be larger than the threshold
...
%   Qiu et al, "Extracting a Cellular Hierarchy from High-dimensional Cytometry Data with SPADE", Nature Biotechnology, 29(10):886-891, 2011. 
...
% (1) compute the corr between the PCAs of all pairs of clusters (2)
% line 44 if the corr of a pair of PCAs from two clusters is bigger than
