function [accuracy, roc_x, roc_y, roc_t, auc, mcorr, selected_features,selected_weights, confusion_table] = L1_regularized_logistic_regression_binary(X,Y,feature_names, isdisplay)
