...
ntree = 50; 
B = TreeBagger(ntree,X,Y,'InBagFraction',1,'Method','classification','OOBPrediction','on','OOBPredictorImportance','on','PredictorSelection','interaction-curvature');
...
for i=1:5
    ...
    test_X = X(cv_ind==i,:);
    test_Y = Y(cv_ind==i);
    B2 = TreeBagger(ntree,train_X,train_Y(:),'InBagFraction',1,'Method','classification','OOBPrediction','on','OOBPredictorImportance','on','PredictorSelection','interaction-curvature');
...
B2.OOBPermutedPredictorDeltaError
